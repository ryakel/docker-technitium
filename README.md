# [docker-technitium](https://github.com/ryakel/docker-technitium)
...
```yml
  dnsserver:
    ...
    image: ryakel/ts-dnsserver:latest
    ports:
      - 53:53/udp
      - 5380:5380
    volumes:
...
```bash
docker run -p 53:53/udp -p 5380:5380 -v ${PWD}/ts-dnsserver:/config -e PUID=1000 -e PGID=1000 ryakel/ts-dnsserver:latest
```
